...
from media_indexer_backend.services.vips_image_service import render_preview_and_blurhash
        ...
        *,
        ...
        try:
            if media_type == MediaType.IMAGE:
                blur_hash = render_preview_and_blurhash(
                    source_path,
                    output_path,
                    max_size=self.settings.max_thumbnail_size,
                    quality=88,
                )
