...
from media_indexer_backend.platform.registry import ensure_runtime_import_paths, iter_backend_entrypoints, iter_worker_entrypoints
...
def bootstrap_platform(session: Session, *, runtime: str = "backend") -> None:
    ...
    ensure_runtime_import_paths(runtime)
